    ...
    if last_avg_price_17_to_20 is not None and lowest_price_17_to_07 is not None:
        ...
        if last_days_savings > 0:
            print(
                ...
                + f" kommande natt sparar {last_days_savings}ore."
            )
...
def print_last_day_info(
    ...
    print(
        ...
        + f"\nDin dyraste timme b�rjade {most_expensive_hour}:00. "
        + f"Denna timmen kostade dig {most_expensive_hour_cost} �re."
        + f" ({most_expensive_hour_price} �re/kWh)"
    )
